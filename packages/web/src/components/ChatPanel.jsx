...
function ChatPanel({ communityId, communityName, isOnline = true }) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <form onSubmit={handleSubmit} className="border-t border-gray-200 dark:border-neutral-700 p-4 flex gap-2">
        <input
          type="text"
          value={input}
        ...
        <button
          ...
          className="rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-blue-700 disabled:bg-gray-300 dark:disabled:bg-neutral-600 disabled:cursor-not-allowed"
        >
          Send
        </button>
      </form>
