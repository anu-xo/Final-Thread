...
export default function Header() {
  ...
  return (
    ...
    >
      {/* Hamburger menu — hidden on lg+ (1024px+) where sidebar is always inline */}
      <button
      ...
      {/* Search bar — visible sm+ (640px+); on xs show a search icon button instead */}
      ...
      {/* Mobile search icon — visible below sm (640px) */}
      <button
            ...
            <div className="relative" ref={menuRef}>
              ...
              {menuOpen && (
                ...
                >
                  ...
                  <button onClick={handleLogout} className="w-full text-left px-4 py-2 text-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20" role="menuitem">
                    Log Out
                  </button>
                </div>
              )}
