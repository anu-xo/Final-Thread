...
export default function Header() {
  ...
  return (
    <header
      className="fixed left-0 right-0 z-50 h-14 bg-white dark:bg-neutral-900 border-b border-gray-200 dark:border-neutral-700 flex items-center px-4 gap-4"
    ...
    >
      ...
      <form onSubmit={handleSearch} className="flex-1 max-w-xl">
        <input
          ...
          className="w-full px-4 py-1.5 rounded-full border border-gray-300 dark:border-neutral-600 bg-gray-50 dark:bg-neutral-800 text-sm focus:outline-none focus:border-orange-400 focus:bg-white dark:focus:bg-neutral-700 dark:text-neutral-200 placeholder:text-gray-400 dark:placeholder:text-neutral-500"
        />
      </form>
          ...
          <>
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-neutral-300 hover:text-orange-500"
              >
              ...
              {menuOpen && (
                ...
                >
                  <Link to={`/u/${user.username}`} className="block px-4 py-2 text-sm hover:bg-gray-50 dark:hover:bg-neutral-700" onClick={() => setMenuOpen(false)}>Profile</Link>
                  <Link to="/settings" className="block px-4 py-2 text-sm hover:bg-gray-50 dark:hover:bg-neutral-700" onClick={() => setMenuOpen(false)}>Settings</Link>
