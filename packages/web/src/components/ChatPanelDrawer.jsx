...
export default function ChatPanelDrawer() {
  ...
  // Slide-in from the right; a spring that's quick enough to feel responsive.
  // prefers-reduced-motion: appear instantly, no slide.
  ...
  return (
    <AnimatePresence>
      ...
      {chatPanelOpen && (
        <motion.div
          key="chat-panel"
          className="fixed top-0 right-0 z-50 h-full w-full max-w-md bg-white dark:bg-neutral-900 border-l border-gray-200 dark:border-neutral-700 shadow-2xl"
