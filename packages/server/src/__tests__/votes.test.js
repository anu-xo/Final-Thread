...
describe('POST /api/votes', () => {
  ...
  afterAll(async () => {
    // Clear all records generated by this user across tests to prevent database leaking
  ...
  it('emits vote:updated to parent post room for comment votes', async () => {
    ...
    expect(mockEmit).toHaveBeenCalledWith('vote:updated', expect.objectContaining({
